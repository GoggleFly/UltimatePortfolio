...
/// An environment singleton respnosible for managing our Core Data stack, including handling saving,
...
class DataController: ObservableObject {
    ...
    func issuesForSelectedFilter() -> [Issue] {
        ...
        if let tag = filter.tag {
            ...
            let datePredicate = NSPredicate(format: "modificationDate > %@", filter.minimumModificationDate as NSDate)
